...
blueprint= Blueprint('login', __name__, template_folder="../html", url_prefix='/login')
...
@blueprint.route('/user/api/register', methods=['POST'])
def api_register():
...
@blueprint.route('/user/api/login', methods=['POST'])
